 ...
 * @author Ando Henri
 */
public class FormPret extends javax.swing.JPanel {

    public FormPret(Type type) {
        initComponents();
        setOpaque(false);
        if (type == Type.UPDATE){
            jLabel1.setText("Mettre à jour un pret");
        }else{
            jLabel1.setText("Enregistrer un pret");
    ...
    private void initComponents() {
        ...
        txtNumCompte = new com.dojo.component.TextField();
        txtMontantPret = new com.dojo.component.TextField();
        ...
        txtNumCompte.setBordColor(new java.awt.Color(129, 202, 178));
        txtNumCompte.setHints("N°compte prêteur");

        txtMontantPret.setBordColor(new java.awt.Color(129, 202, 178));
        txtMontantPret.setHints("Montant (Ariary)");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btnPreDelete, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnPreRegister, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtMontantPret, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap(50, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtMontantPret, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
    ...
    public String getNumComptePret(){
        return txtNumCompte.getText();
    }
    public String getMontant(){
        return txtMontantPret.getText();
    }
    public void setNumComptePret(String nom){
        txtNumCompte.setText(nom);
    }
    public void setMontant(int montant){
        txtMontantPret.setText(String.valueOf(montant));
    }
    ...
    private com.dojo.component.TextField txtMontantPret;
    private com.dojo.component.TextField txtNumCompte;
