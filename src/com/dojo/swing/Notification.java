...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS){
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/dojo/icon/sucess.png")));
            lbMessage.setText("Success");
        }else if (type == Type.INFO){
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/dojo/icon/info.png")));
            lbMessage.setText("Info");
        }else{
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/dojo/icon/error.png")));
    ...
    public void paint(Graphics grphcs) {
        ...
        if (null == type) {
            ...
            case SUCCESS -> g2.setColor(new Color(18, 163, 24));
            case INFO -> g2.setColor(new Color(28, 139, 206));
            default -> g2.setColor(new Color(240, 52, 53));
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dojo/icon/sucess.png"))); // NOI18N
        ...
        btnClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dojo/icon/close.png"))); // NOI18N
